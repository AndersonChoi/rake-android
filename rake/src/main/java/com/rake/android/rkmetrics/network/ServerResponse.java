...
public final class ServerResponse {
    ...
    private ServerResponse(String responseBody, int responseCode, long serverResponseTime, String flushMethod) {
    ...
    public ServerResponse(Throwable e, Status flushStatus, String flushMethod) {
        this.throwable = e;
    ...
    public static ServerResponse create(String responseBody, int responseCode, long serverResponseTime, String flushMethod) {

        /** 오류가 아니라 body 는 파싱 실패시 NULL 일 수 있으므로 result 만 검사하도록 작성 */
        return new ServerResponse(responseBody, responseCode, serverResponseTime, flushMethod);
    }

    public static ServerResponse createErrorResponse(Throwable e, Status flushStatus, String flushMethod) {
        if (flushStatus == null) {
            return null;
        }
